...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Matrel /</span> Data Project</h4>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <!-- Filter Form -->
                    <form method="GET" action="{{ route('superadmin.matrel') }}"
                        ...
                        <!-- Filter Kategori - Only show Material and Material dan Jasa -->
                        <div class="form-group" style="min-width: 200px;">
                    ...
                    <!-- <div class="d-flex gap-2">
                        <a href="{{ route('superadmin.import-data') }}" class="btn btn-success">
