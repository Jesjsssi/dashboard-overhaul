...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">
            <span class="text-muted fw-light">Plan Step Duration /</span> Tambah Plan Step Duration
        </h4>
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="mb-0">Form Tambah Plan Step Duration</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('superadmin.plan-step-duration.store') }}" method="POST">
                            @csrf
                            <div class="row mb-3">
