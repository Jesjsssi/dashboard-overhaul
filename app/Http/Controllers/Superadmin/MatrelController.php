...
class MatrelController extends Controller
{
    public function index(Request $request)
    {
        $query = Project::with(['eps', 'disiplin', 'subDisiplin']);

        // Only include projects with kategori Material or Material dan Jasa by default
        $query->whereIn('kategori', ['Material', 'Material dan Jasa']);
        ...
        // Log untuk debugging
        Log::info('Matrel filter parameters:', [
        ...
        return view('superadmin.matrel.index', compact('projects'));
    }
}
